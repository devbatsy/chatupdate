...
__SYD.search_result_component_addUser = ({accessKey , compName , accessName = 'children'} = {}) =>{
    ...
    return __c(
        "div",
        {
            style:`padding:7px 0;font-size:14px;display:flex;align-items:center;cursor:pointer;border-bottom:1px solid ${SYD_VAR.plum_light_grey};position:relative;`
        },
        [
            __c(
                "i",
