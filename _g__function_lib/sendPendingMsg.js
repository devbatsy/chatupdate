...
const sendPendingMsg = async ({
    ...
    try{
        ...
        const newMessage__sender = new chatObject({text:msg , lang:chatRoom.language[privKeys.senderPrivKey] , msgID:messageID , senderPubID:sender , sendState:true}).getObject();
        ...
        const translatedText = await translateText(`${msg}`, chatRoom.language[privKeys.recieverPrivKey]);
